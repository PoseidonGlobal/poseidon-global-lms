  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Hero 
        ...
        subtitle="Manage users, courses, and system settings"
      />
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-600">0 registered students</p>
                    </div>
                  </div>
                  <button className="text-poseidon-blue hover:text-blue-600">
                    Manage →
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-600">0 faculty members</p>
                    </div>
                  </div>
                  <button className="text-poseidon-blue hover:text-blue-600">
                    Manage →
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="p-6">
              <div className="text-center py-8">
                ...
                <button className="mt-4 bg-poseidon-blue text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-200">
                  Create First Course
                </button>
              </div>
            </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Track registration trends</p>
              </div>
